...
const WORDS = ["Tech Enthusiast", "Data Scientist" ,"AI Engineer"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/mnabilfs", label: "GitHub Profile" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/muhammad-nabil-farras-sulthan-6ba171290/", label: "LinkedIn Profile" },
  { icon: Instagram, link: "https://www.instagram.com/muhammadnabil_fs/?hl=id", label: "Instagram Profile" }
];
        ...
        <script type="application/ld+json">{`
          {
            ...
            "sameAs": [
              ...
              "https://www.instagram.com/muhammadnabil_fs/"
            ]
          }
        `}</script>
      </Helmet>
              ...
              <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                    data-aos="fade-up"
                    data-aos-delay="1000">
                    Menciptakan Teknologi Yang Inovatif, Fungsional, dan User-Friendly untuk Solusi Digital.
                  </p>
