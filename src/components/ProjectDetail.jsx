...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/mnabilfs",
      };
  ...
  return (
    <>
      <Helmet>
        <title>{project.Title} — Muhammad Nabil Farras Sulthan</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Muhammad Nabil Farras Sulthan — Fullstack Web Developer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Muhammad Nabil Farras Sulthan`}
        />
        <meta
